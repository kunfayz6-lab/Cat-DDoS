...
def print_summary(url: str, duration: int, concurrency: int, method: str, rate_limit: float | None, summary: dict):
    ...
    print(f"{Fore.CYAN}║{Fore.BLUE} ╚═••⟩ Target     : {url.ljust(58)}║")
    print(f"{Fore.CYAN}║{Fore.BLUE} ╚═••⟩ Duration   : {str(duration)+'s':<58}║")
    print(f"{Fore.CYAN}║{Fore.BLUE} ╚═••⟩ Concurrency: {str(concurrency):<58}║")
    print(f"{Fore.CYAN}║{Fore.BLUE} ╚═••⟩ Method     : {method:<58}║")
    print(f"{Fore.CYAN}║{Fore.BLUE} ╚═••⟩ Rate limit : {('None' if not rate_limit else str(rate_limit)+' req/s'):<58}║")
    print(f"{Fore.CYAN}╚{'═' * 50}╝")
    print(f"{Fore.CYAN}║{'═' * 50}║")
