...
f"{Fore.BLUE}║{Fore.GREEN}                       / /       \(  )/    --------                    {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                      //////     . \/ -   ------                       {Fore.BLUR}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                     //// / //   :    : -----                          {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                    // /   /     '`   ,-----                           {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                   // /  //    / //..\\\                                {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                  //          / //,..,\\\                               {Fore.BLUE}║ ",         
f"{Fore.BLUE}║{Fore.GREEN}                                                                       {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.GREEN}                           ====UU====UU====                            {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.YELLOW}       ╔═════════╗{Fore.GREEN}               //||\\{Fore.YELLOW}{Fore.WHITE}          ╔═════════╗           {Fore.BLUE}║ ",     
f"{Fore.BLUE}║{Fore.YELLOW}       ██████████╝{Fore.GREEN}             ////||\\\\\{Fore.YELLOW}         ██████████{Fore.WHITE}║           {Fore.BLUE}║ ",     
f"{Fore.BLUE}║{Fore.YELLOW}       ██║             {Fore.GREEN}          ''``{Fore.YELLOW}                ██{Fore.WHITE}║               {Fore.BLUE}║ ", 
f"{Fore.BLUE}║{Fore.YELLOW}       ██║                    ╔═══════╗              ██{Fore.WHITE}║               {Fore.BLUE}║ ",         
f"{Fore.BLUE}║{Fore.YELLOW}       ██║                    ████████╚╗             ██{Fore.WHITE}║               {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.YELLOW}       ██║                   ██║      ██║            ██{Fore.WHITE}║               {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.YELLOW}       ██║                   ██║      ██║            ██{Fore.WHITE}║               {Fore.BLUE}║ ",
f"{Fore.BLUE}║{Fore.YELLOW}       ██╚═══════╗           ██║      ██║            ██{Fore.WHITE}║              {Fore.BLUE}║ ",
