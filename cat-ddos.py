...
def countdown(t):
    ...
    while True:
        ...
        if remaining_time > 1:
            ...
            print(f"{Fore.RED}[]  \033[103mC \033[106mA \033[103mT {Fore.WHITE} •>  {Fore.BLUE}Request {Fore.GREEN}" +str(url)+ ")")
            print(f"{Fore.WHITE}[]  \033[104mC \033[7mA \033[41mT {Fore.MAGENTA}•> {Fore.CYAN}Attack° {Fore.MAGENTA}" +str(url)+ ")")
        else:
            stdout.flush()
    ...
    async with aiohttp.ClientSession(timeout=timeout, connector=conn) as session:
        ...
        async def progress():
            while time.time() < end_ts:
                ...
                print({Fore.RED}[]  "\033[103mC\033[0m") "\033[106mA\033[0m") "\033[103mT\033[0m") {Fore.WHITE} •>  {Fore.BLUE}Request {Fore.GREEN}" +str(url)+ "))))
                print({Fore.WHITE}[]  "\033[104mC\033[0m") "\033[7mA\033[0m") "\033[41mT\033[0m") {Fore.MAGENTA}•> {Fore.CYAN}Attack° {Fore.MAGENTA}" +str(url)+ "))))
